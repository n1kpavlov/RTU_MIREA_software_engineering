...
public class NomenclatureController {
    ...
    public NomenclatureController() {
        nomenclatureList = new CsvToBeanBuilder<Nomenclature>(new InputStreamReader
                (this.getClass().getResourceAsStream("/MOCK_DATA.csv"))).withType(Nomenclature.class).build().parse();
    }
